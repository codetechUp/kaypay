...
class Osms
{
     ...
     * @var string
     */
    protected $clientId = 'FAxUMbtARsEUcjyRbWNl1AZkvinP4i2p';
    /**
     * Client Secret. Used to sign/crypt the requests.
     *
     * @var string
     */
    protected $clientSecret = 'GkZOtMokJu8UHIdE';
    /**
     * The Token will be used for all further API calls.
     *
     * @var string
     */
    protected $token = 'Basic RkF4VU1idEFSc0VVY2p5UmJXTmwxQVprdmluUDRpMnA6R2taT3RNb2tKdThVSElkRQ==';
    /**
    ...
    public function sendSms(
        ...
        $senderAddress='tel:+221775516254';
